...
class HtmlThrough extends stream.Transform {
    constructor() {
...
class IndexerStream extends stream.Readable {
...
class HtmlIndexer extends events.EventEmitter {
    constructor() {
        super();
...
exports.HtmlIndexer = HtmlIndexer;
